...
<html lang="en">
  ...
  <section id="nav-bar">
    ...
    <div class="row text-center mb-3">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan8.php"><img src="../images/slide23/slide23-1.webp "></a>
            <p><strong>5 Bedroom House Design</strong></p>
            <p></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan9.php"><img src="../images/slide8/slide8-1.jpg"></a>
            <p><strong>Nice Flat modern design</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan10.php"><img src="../images/slide9/slide9-1.jpg"></a>
            <p><strong>9 bedroom flat house plan</strong></p>
        </div>
        </div>
    </div>
    ...
    <div class="row text-center">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan11.php"><img src="../images/slide10/slide10-1.jpg" alt="image1"></a>
            <p><strong>A nice 3 bedroom house plan</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan12.php"><img src="../images/slide11/slide11-1.webp"></a>
            <p><strong>Morden flat house design</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan13.php"><img src="../images/slide12/slide12-1.webp"></a>
            <p><strong>Perfectly suitable for a sloppy site</strong></p>
        </div>
        </div>
    </div>

    <div class="next-page">
        <a href="properties.php" class="previous round">&#8249;</a>
