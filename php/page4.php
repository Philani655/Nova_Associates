...
<html lang="en">
  ...
  <section id="nav-bar">
    ...
    <div class="row text-center mb-3">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan19.php"><img src="../images/slide19/slide19-1.jpg"></a>
            <p><strong>2 floor luxurious mansion</strong></p>
            <p></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan20.php"><img src="../images/slide20/slide20-1.jpg"></a>
            <p><strong>Auspicious mansion</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan21.php"><img src="../images/slide21/slide21-1.jpg"></a>
            <p><strong>A 2 storey modern contemporary</strong></p>
        </div>
        </div>
    </div>
    ...
    <div class="row text-center">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan22.php"><img src="../images/slide22/slide22-1.jpg" alt="image1"></a>
            <p><strong>Double story with flat roofs</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan23.php"><img src="../images/slide24/slide24-1.webp"></a>
            <p><strong>Morden Double Story House Design</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan24.php"><img src="../images/slide25/slide25-1.webp"></a>
            <p><strong>4 Storey Beach House Design</strong></p>
        </div>
        </div>
    </div>
