    ...
    <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">3 bedroom flat house plan</h3>
                    <p>
                       3 bedroom flat house plan, with a Single garage,
                       Bathroom and an Open plan Kitchen and Lounge.
                    </p>
                    <p class="display-flex"><strong>From R2,500.00</strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>3 bedroom flat house plan</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="2585">Digital copy (PDF)</option>
                                                    ...
                                                    <input type="hidden" name="name" value="3 bedroom flat house plan">
                                                    <p class="text-center mt-3">Total Order: <b>R2,500.00</b></p>
                        ...
                        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#myModalPrice">Pricing</button>
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R2,500.00</b></h4>
                                            <button type="button" onclick="submit_form()"class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                                <li>Site Plan</li>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R2,500.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide1/image1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide1/image2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide1/image3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide1/image4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide1/image5.jpg" class="d-block w-100" alt="image5">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide1/image6.jpg" class="d-block w-100" alt="image6">
                    </div>
                </div>
