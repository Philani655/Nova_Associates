        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-3">
                    <h3 class="fw-bold">9 bedroom flat house plan</h3>
                    <p class="mt-3">
                        A design contained: Single Garage, Open plan (Kitchen, Lounge), 3 Bedrooms, 
                        1 Bathroom, Toilet and 2 covered patios.
                    </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>9 bedroom flat house plan</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="name" value="9 bedroom flat house plan">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide9/slide9-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide9/slide9-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide9/slide9-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                </div>
