        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-4">
                    ...
                    <p class="mt-4">
                       A design contained: 1 Kitchen, 2 Bedroom, Dining room and bathroom.
                    </p>
                    <p class="display-flex"><strong>From R1,250.00</strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>Morden flat house design</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="1350">Digital copy (PDF)</option>
                                                                <option id="price" value="1300">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <p class="text-center mt-3">Total Order: <b>R1,250.00</b></p>
                        ...
                        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#myModalPrice">Pricing</button>
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R1,250.00</b></h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R1,250.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide11/slide11-1.webp" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide11/slide11-2.webp" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide11/slide11-3.webp" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide11/slide11-4.webp" class="d-block w-100" alt="image4">
                    </div>
                </div>
