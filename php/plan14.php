        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-4">
                    <h3 class="fw-bold">Morden flat house</h3>
                    <p class="mt-4">
                       A design contained: Double Garage, 2 Master Bedrooms, 2 Dressing rooms, 2 Ensuites,
                       A kitchen, Dining Room, Lounge, Uncovered Patio and Toilet.
                    </p>
                    <p class="display-flex"><strong>From R2,600.00</strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>Morden flat house plan</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="2700">Digital copy (PDF)</option>
                                                                <option id="price" value="2650">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="name" value="Morden flat house">
                                                    <p class="text-center mt-3">Total Order: <b>R2,600.00</b></p>
                        ...
                        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#myModalPrice">Pricing</button>
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R2,600.00</b></h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R2,600.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide2/slide2-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-5.jpg" class="d-block w-100" alt="image5">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-6.jpg" class="d-block w-100" alt="image6">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-7.jpg" class="d-block w-100" alt="image7">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-8.jpg" class="d-block w-100" alt="image8">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide2/slide2-9.jpg" class="d-block w-100" alt="image9">
                    </div>
                </div>
