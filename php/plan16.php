        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-4">
                    <h3 class="fw-bold">1 eight corner rondavels and garage</h3>
                    <p class="mt-4">
                        A design contained: 1 Eight corner rondavels and garage.
                    </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>1 eight corner rondavels and garage</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="name" value="1 eight corner rondavels and garage">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide4/slide4-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide4/slide4-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide4/slide4-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide4/slide4-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                </div>
