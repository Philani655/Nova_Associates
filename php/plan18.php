        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">2 eight corner rondavels</h3>
                    <p>
                        A nice and simple House design consisting of 2 eight corner rondavels
                        with a Single garage in between. Perfect for a site of 225msq.
                    </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>2 eight corner rondavels</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="name" value="2 eight corner rondavels">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide6/slide6-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide6/slide6-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide6/slide6-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide6/slide6-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide6/slide6-5.jpg" class="d-block w-100" alt="image5">
                    </div>
                </div>
