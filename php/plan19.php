...
<div class="container-fluid">
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            <div class="row">
                ...
                <h3 class="fw-bold">2 floor luxurious mansion</h3>
                    <p>
                        This luxurious mansion contains: 2 Floors and Basement with 2 Garage.
                    </p>
                    <p class="display-flex"><strong>From R6,500.00</strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>2 floor luxurious mansion</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="6600">Digital copy (PDF)</option>
                                                                <option id="price" value="6550">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="name" value="2 floor luxurious mansion">
                                                    <p class="text-center mt-3">Total Order: <b>R6,500.00</b></p>
                        ...
                        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#myModalPrice">Pricing</button>
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R6,500.00</b></h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R6,500.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide19/slide19-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-5.jpg" class="d-block w-100" alt="image5">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-6.jpg" class="d-block w-100" alt="image6">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-7.jpg" class="d-block w-100" alt="image7">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-8.jpg" class="d-block w-100" alt="image8">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide19/slide19-9.jpg" class="d-block w-100" alt="image9">
                    </div>
                </div>
