        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">Auspicious mansion</h3>
                    <p>
                        Auspicious mansion contained: 2 Floors, 10 bedroom with a butterfly roof designed.
                    </p>
                    <p class="display-flex"><strong>From R7,000.00</strong></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>Auspicious mansion</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="7100">Digital copy (PDF)</option>
                                                                <option id="price" value="7050">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="name" value="Auspicious mansion">
                                                    <p class="text-center mt-3">Total Order: <b>R7,000.00</b></p>
                        ...
                        <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#myModalPrice">Pricing</button>
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R7,000.00</b></h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R7,000.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide20/slide20-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide20/slide20-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide20/slide20-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide20/slide20-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide20/slide20-5.jpg" class="d-block w-100" alt="image5">
                    </div>
                </div>
