    ...
    <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">Morden Double Story and flat houses</h3>
                    <p>
                        Morden double story and flat houses with 5 bedroom and single garage
                    </p>
                    <p class="display-flex"><strong>From R3,300.00</strong></p>
                    ...
                    <div class="d-grid gap-3 d-md-flex justify-content-md-center">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>Morden Double Story and flat houses</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="3400">Digital copy (PDF)</option>
                                                                <option id="price" value="3350">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="document" value="../house_plan_documents/5 Bedroom House Design.pdf">
                                                    <input type="hidden" name="name" value="Morden Double Story and flat houses">
                                                    <p class="text-center mt-3">Total Order: <b>R3,300.00</b></p>
                                                    <div class="modal-footer">
                                                        <a href="confirmation.php"><button type="button" class="btn btn-secondary btn-lg">Next</button></a>
                                                    </div>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal" id="myModalPrice">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Non Approval<br><b>R3,300.00</b></h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Municipal<br><b>R3,300.00 plus R400 for enquiry</b></h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul>
                                        ...
                                        <div class="modal-footer justify-content-md-center">
                                            <button type="button" onclick="submit_form_order()"class="btn btn-secondary btn-lg">Place an order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide16/slide16-1.webp" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-2.webp" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-3.webp" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-4.webp" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-5.webp" class="d-block w-100" alt="image5">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-6.webp" class="d-block w-100" alt="image6">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-7.webp" class="d-block w-100" alt="image7">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-8.webp" class="d-block w-100" alt="image8">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide16/slide16-9.webp" class="d-block w-100" alt="image9">
                    </div>
                </div>
