        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">A 3 story luxury house design</h3>
                    <p>
                        A 3 story luxury house design with a nice landscaping design.
                    </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>A 3 story luxury house design</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mt-1">
                                                            <select class="rounded p-2" name="price">
                                                                <option id="price" value="2600">Digital copy (PDF)</option>
                                                                <option id="price" value="2550">Printing</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <input type="hidden" name="name" value="A 3 story luxury house design">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide18/slide18-1.jpg" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide18/slide18-2.jpg" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide18/slide18-3.jpg" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide18/slide18-4.jpg" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide18/slide18-5.jpg" class="d-block w-100" alt="image5">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide18/slide18-6.jpg" class="d-block w-100" alt="image6">
                    </div>
                </div>
