        ...
        <form id="paymentForm" action="../php/customer_order_file.php" method="post" class="mx-auto">
            <div class="row">
                <div class="col-sm-6 mt-5">
                    <h3 class="fw-bold">5 Bedroom House Design</h3>
                    <p>
                       5 bedroom house design with kitchen, bathroom, 2 bedroom and single garage
                    </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h4 class="modal-title mt-3 w-100">Place an order for: <br>5 Bedroom House Design</h4>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="name" value="5 Bedroom House Design">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="../images/slide23/slide23-1.webp" class="d-block w-100" alt="image1">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide23/slide23-2.webp" class="d-block w-100" alt="image2">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide23/slide23-3.webp" class="d-block w-100" alt="image3">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide23/slide23-4.webp" class="d-block w-100" alt="image4">
                    </div>
                    <div class="carousel-item">
                    <img src="../images/slide23/slide23-5.webp" class="d-block w-100" alt="image5">
                    </div>
                </div>
