...
<section id="nav-bar">
    ...
    <div class="row text-center mb-3">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="plan2.php"><img src="../images/slide13/slide13-1.webp"></a>
            <p><strong>Flat Roofs Double Story House Plan</strong></p>
            <p></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan3.php"><img src="../images/slide14/slide14-1.webp"></a>
            <p><strong>Morden Double Story House Plan</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan4.php"><img src="../images/slide15/slide15-1.webp"></a>
            <p><strong>Allure Morden Double Story Design</strong></p>
        </div>
        </div>
    </div>
    ...
    <div class="row text-center">
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan5.php"><img src="../images/slide16/slide16-1.webp" alt="image1"></a>
            <p><strong>Morden double Story and flat houses</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan6.php"><img src="../images/slide17/slide17-1.webp"></a>
            <p><strong>An auspicious mansion designed</strong></p>
        </div>
        </div>
        <div class="col-sm-4">
        <div class="thumbnail">
            <a href="../php/plan7.php"><img src="../images/slide18/slide18-1.jpg"></a>
            <p><strong>A 3 story luxury house design</strong></p>
        </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-5" onsubmit="return email_validation()">
            <div class="row" >
        ...
        <div class="row">
            <div class="col-sm-12 form-group mb-3">
                <button class="btn btn-default pull-right bg-secondary" type="button" onclick="email_validation()">Send</button>
            </div>
        </div>
        </div>
    </div>
    ...
    <footer class="bg-dark">
        ...
        <script src="../javascript/email_sent_validation.js"></script>
